...
def TestGen_ValHeldoutFromUnseen_multiclass(train_x_list, train_y_list, unseen, K_thr = 500, num_of_chunks_to_aggregate = 25, k = 1, class_names=["1", "2", "3", "4", "5"]):
  ...
  clf,val_auc,test_auc,val_acc,test_acc,proba_val,proba_test,ypt,test_macro_f1,cm=train_eval_xgboost_classifier_multiclass_opt_th(Z_train,y_train,
  ...
  return clf,val_auc,test_auc,val_acc,test_acc,proba_val,proba_test,ypt,test_macro_f1,cm
