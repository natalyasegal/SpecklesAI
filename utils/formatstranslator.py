...
def rearrange_input_s(x, need_to_shuffle_within_category, 
                      MAX_CHUNKS_PER_CATEGORY, number_of_classes = 2, Verbose = False):
      '''
      ...
      print(f'max_chanks per category={MAX_CHUNKS_PER_CATEGORY}')
...
def limit_rearrange_and_flatten_s(input_data, need_to_shuffle_within_category, MAX_CHUNKS_PER_CATEGORY, number_of_classes = 2, Verbose = False):
...
def test2trainformat(input_data, need_to_shuffle_within_category = False, MAX_CHUNKS_PER_CATEGORY = 500000, Verbose = False):
