...
class Configuration():
  def __init__(self, verbose = True):
    ...
    self.sub_Ci = 'visual/circle_im' 
    self.sub_Cr = 'visual/circle_r'
    self.sub_Ti = 'visual/triangle_im'
    self.sub_Tr = 'visual/triangle_r'
    self.frames_subdirs_dict = {self.sub_Ci:"circle_im", self.sub_Cr:"circle_r", self.sub_Ti:"triangle_im", self.sub_Tr:"triangle_r"}
